    ...
    config.set({
        ...
        systemjs: {
            ...
            config: {
                ...
                paths: {
                    'plugin-babel': 'app/libs/npm/systemjs-plugin-babel@0.0.17/plugin-babel.js',
                    'systemjs-babel-build': 'app/libs/npm/systemjs-plugin-babel@0.0.17/systemjs-babel-browser.js',
                    "systemjs-test/*": "./*",
                    "bundles/*": "bundles/*",
                    "jspm_packages/*": "libs/*",
            ...
            // Fichiers utilisés pour les tests par le navigateur
            serveFiles: [
                'app/libs/{,**/}*',
                'target/tmp/src/{,**/}*.js',
                'target/tmp/src/{,**/}*.css',
