...
// Construction de la conf de browser sync (serveur http local + watch auto)
// middleware : permet d'enrichir les comportements de browsersync
...
gulp.task('serve', ['lint', 'watch'], function (done) {
    ...
    // extensiion pour le mocking + proxy
